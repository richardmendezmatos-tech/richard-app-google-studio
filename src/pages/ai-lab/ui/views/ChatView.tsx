    ...
    <div className="flex flex-col h-full max-w-4xl mx-auto w-full p-4 lg:p-8">
        ...
        {messages.length === 1 && messages[0].id === 'welcome' && (
          <div className="flex flex-col items-center justify-center py-10 text-slate-500 space-y-4">
            <div className="p-5 bg-slate-800/30 rounded-full border border-white/5">
              <Bot size={48} className="text-primary/30" />
            </div>
      ...
      <form onSubmit={handleSubmit} className="relative group mt-auto pt-4">
        <input
          ...
          className="w-full bg-[#131f2a] border border-white/10 text-slate-100 rounded-[24px] py-5 pl-8 pr-16 focus:ring-2 focus:ring-primary focus:border-transparent outline-none transition-all shadow-2xl placeholder:text-slate-600 font-medium"
        />
        <button
          type="submit"
