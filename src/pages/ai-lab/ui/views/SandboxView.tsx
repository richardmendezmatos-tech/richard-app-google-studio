      ...
      <div className="flex flex-col md:flex-row justify-between items-end gap-6">
        ...
        <div className="flex bg-slate-900/50 p-1 rounded-xl border border-white/10">
          <button
            ...
            className={`px-4 py-2 rounded-lg text-xs font-black uppercase tracking-widest transition-all ${activeTab === 'performance' ? 'bg-primary text-white shadow-lg' : 'text-slate-500 hover:text-white'}`}
          >
            DOM Stress Test
          </button>
          <button
            ...
            <div className="bg-white/5 border border-white/5 p-8 rounded-[2rem] space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-1">
                  ...
                  <code className="text-[11px] block bg-black p-3 rounded-xl border border-white/10 text-primary font-mono">
