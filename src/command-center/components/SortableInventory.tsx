  ...
  return (
    ...
    >
      <div
        {...attributes}
        {...listeners}
        className="cursor-grab active:cursor-grabbing text-slate-600 hover:text-[#00aed9]"
      >
      ...
      <div className="text-sm font-black text-[#00aed9]">${car.price.toLocaleString()}</div>
    </div>
  );
};
