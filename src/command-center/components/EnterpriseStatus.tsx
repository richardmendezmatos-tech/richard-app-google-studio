...
import { enterpriseService, SystemHealth } from '@/core-infra/enterprise/EnterpriseClient';
    ...
    >
      ...
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-2">
          <div
            className={`p-2 rounded-lg ${isUp ? 'bg-emerald-500/10 text-emerald-400' : 'bg-red-500/10 text-red-400'}`}
          >
            <Server size={20} />
          </div>
          <div>
      ...
      <div className="grid grid-cols-2 gap-2 mt-2">
        ...
        <div className="bg-black/20 rounded-lg p-2 border border-white/5">
          ...
          <span className="text-xs font-mono font-medium text-white">{isUp ? '< 5ms' : '--'}</span>
        </div>
