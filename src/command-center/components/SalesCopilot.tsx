  ...
  return (
    <div className="bg-[#0b1116] rounded-[40px] p-6 lg:p-10 border border-white/5 shadow-2xl overflow-hidden route-fade-in flex flex-col h-[75vh]">
              ...
              <div
                className={`w-10 h-10 shrink-0 rounded-2xl flex items-center justify-center shadow-lg ${
                  msg.role === 'user'
                    ...
                    : 'bg-gradient-to-br from-[#00aed9] to-blue-600 border border-cyan-400/30'
                }`}
              >
                {msg.role === 'user' ? (
        ...
        {isTyping && (
          <div className="flex w-full justify-start">
            <div className="flex items-start gap-4 max-w-[85%]">
              <div className="w-10 h-10 shrink-0 rounded-2xl flex items-center justify-center bg-gradient-to-br from-[#00aed9] to-blue-600 opacity-50">
                <Bot size={20} className="text-white" />
              </div>
      ...
      <form onSubmit={handleSendMessage} className="relative mt-auto shrink-0 group">
        ...
        <div className="relative flex items-center bg-[#131f2a] border border-white/10 rounded-2xl p-2 focus-within:border-[#00aed9]/50 transition-colors shadow-2xl">
          <input
            type="text"
            value={inputMessage}
          ...
          <button
            ...
            className="bg-[#00aed9] hover:bg-cyan-500 text-white w-12 h-12 rounded-xl flex items-center justify-center transition-all disabled:opacity-30 disabled:hover:bg-[#00aed9]"
          >
