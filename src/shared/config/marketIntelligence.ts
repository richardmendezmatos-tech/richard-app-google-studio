/**
 * MARKET_INTELLIGENCE_PR
 * Datos estratégicos del mercado automotriz en Puerto Rico (2024-2026).
 * Utilizado por Richard IA Pro para generar comparativos de valor.
 */
...
export const MARKET_INTELLIGENCE_PR = {
  ...
  depreciationNotes: {
    toyota: 'Depreciación mínima (aprox 5-8% anual).',
    luxury: 'Depreciación alta (15-20% anual), excelente para compra de usados certificados.',
    pickups: 'Mantienen valor extremo si son 4x4.',
  },
  terminology: [
    { term: 'Guagua', meaning: 'SUV o Van' },
    { term: 'Pronto', meaning: 'Down Payment' },
    { term: 'Marbete', meaning: 'Registration/Annual Tax' },
