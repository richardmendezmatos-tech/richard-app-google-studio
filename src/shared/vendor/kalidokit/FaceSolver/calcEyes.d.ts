 ...
 */
export declare const getEyeOpen: (
  lm: Results,
  side?: Side,
  {
    high,
 ...
 */
export declare const eyeLidRatio: (
 ...
 */
export declare const stabilizeBlink: (
