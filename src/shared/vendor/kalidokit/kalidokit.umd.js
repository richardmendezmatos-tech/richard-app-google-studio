...
(function (g, x) {
  typeof exports == 'object' && typeof module != 'undefined'
    ...
    : typeof define == 'function' && define.amd
      ? define(['exports'], x)
      : ((g = typeof globalThis != 'undefined' ? globalThis : g || self), x((g.Kalidokit = {})));
})(this, function (g) {
  'use strict';
  const x = (e, t, n) => Math.max(Math.min(e, n), t),
    ...
    I = {
      Face: {
        ...
        head: { x: 0, y: 0, z: 0, width: 0.3, height: 0.6, position: { x: 0.5, y: 0.5, z: 0 } },
        brow: 0,
        pupil: { x: 0, y: 0 },
      },
      Pose: {
        ...
        Spine: { x: 0, y: 0, z: 0 },
        Hips: { position: { x: 0, y: 0, z: 0 }, rotation: { x: 0, y: 0, z: 0 } },
      },
      RightHand: {
  ...
  class i {
    ...
    distance(t, n = 3) {
      return Math.sqrt(
        n === 2
          ...
          : Math.pow(this.x - t.x, 2) + Math.pow(this.y - t.y, 2) + Math.pow(this.z - t.z, 2),
      );
    }
    lerp(t, n) {
    ...
    toSphericalCoords(t = { x: 'x', y: 'y', z: 'z' }) {
      return { theta: Math.atan2(this[t.y], this[t.x]), phi: Math.acos(this[t.z] / this.length()) };
    }
    angleTo(t) {
    ...
    static distance(t, n, r) {
      return Math.sqrt(
        r === 2
          ...
          : Math.pow(t.x - n.x, 2) + Math.pow(t.y - n.y, 2) + Math.pow(t.z - n.z, 2),
      );
    }
    static toDegrees(t) {
      return t * (180 / l);
  ...
  const T = (e) => {
      const t = { r: i.findRotation(e[11], e[13]), l: i.findRotation(e[12], e[14]) };
      ((t.r.y = i.angleBetween3DCoords(e[12], e[11], e[13])),
        (t.l.y = i.angleBetween3DCoords(e[11], e[12], e[14])));
      const n = { r: i.findRotation(e[13], e[15]), l: i.findRotation(e[14], e[16]) };
    ...
    K = (e, t) => (
      e.rotation &&
        ((e.rotation.x *= Math.PI), (e.rotation.y *= Math.PI), (e.rotation.z *= Math.PI)),
      (t.x *= l),
      (t.y *= l),
      (t.z *= l),
      { Hips: e, Spine: t }
  ...
  const G = { upperLeg: { z: 0.1 } },
    E = (e) => {
      const t = i.getSphericalCoords(e[23], e[25], { x: 'y', y: 'z', z: 'x' }),
        ...
        r = i.getRelativeSphericalCoords(e[23], e[25], e[27], { x: 'y', y: 'z', z: 'x' }),
        o = i.getRelativeSphericalCoords(e[24], e[26], e[28], { x: 'y', y: 'z', z: 'x' }),
  ...
  class U {
    static solve(
      t,
      n,
      { runtime: r = 'mediapipe', video: o = null, imageSize: s = null, enableLegs: y = !0 } = {},
    ) {
      var A, B, P, D;
      if (!t && !n) {
      ...
      if (r === 'tfjs' && s) {
        ...
        for (const w of n)
          ((w.x /= s.width), (w.y /= s.height), (w.z = 0), (w.visibility = w.score));
      }
      const a = T(t),
        z = O(t, n),
        h = y ? E(t) : null,
        c = t[15].y > 0.1 || ((A = t[15].visibility) != null ? A : 0) < 0.23 || 0.995 < n[15].y,
        u = t[16].y > 0.1 || ((B = t[16].visibility) != null ? B : 0) < 0.23 || 0.995 < n[16].y,
        f =
          t[23].y > 0.1 ||
  ...
  class J {
    static solve(t, n = p) {
      ...
      return (
        ...
        (s[n + 'RingProximal'] = { x: 0, y: 0, z: i.angleBetween3DCoords(t[0], t[13], t[14]) }),
        (s[n + 'RingIntermediate'] = {
          x: 0,
          y: 0,
          z: i.angleBetween3DCoords(t[13], t[14], t[15]),
        }),
        (s[n + 'RingDistal'] = { x: 0, y: 0, z: i.angleBetween3DCoords(t[14], t[15], t[16]) }),
        (s[n + 'IndexProximal'] = { x: 0, y: 0, z: i.angleBetween3DCoords(t[0], t[5], t[6]) }),
        (s[n + 'IndexIntermediate'] = { x: 0, y: 0, z: i.angleBetween3DCoords(t[5], t[6], t[7]) }),
        (s[n + 'IndexDistal'] = { x: 0, y: 0, z: i.angleBetween3DCoords(t[6], t[7], t[8]) }),
        (s[n + 'MiddleProximal'] = { x: 0, y: 0, z: i.angleBetween3DCoords(t[0], t[9], t[10]) }),
        (s[n + 'MiddleIntermediate'] = {
          x: 0,
          y: 0,
          z: i.angleBetween3DCoords(t[9], t[10], t[11]),
        }),
        (s[n + 'MiddleDistal'] = { x: 0, y: 0, z: i.angleBetween3DCoords(t[10], t[11], t[12]) }),
        (s[n + 'ThumbProximal'] = { x: 0, y: 0, z: i.angleBetween3DCoords(t[0], t[1], t[2]) }),
        (s[n + 'ThumbIntermediate'] = { x: 0, y: 0, z: i.angleBetween3DCoords(t[1], t[2], t[3]) }),
        (s[n + 'ThumbDistal'] = { x: 0, y: 0, z: i.angleBetween3DCoords(t[2], t[3], t[4]) }),
        (s[n + 'LittleProximal'] = { x: 0, y: 0, z: i.angleBetween3DCoords(t[0], t[17], t[18]) }),
        (s[n + 'LittleIntermediate'] = {
          x: 0,
          y: 0,
          z: i.angleBetween3DCoords(t[17], t[18], t[19]),
        }),
        (s[n + 'LittleDistal'] = { x: 0, y: 0, z: i.angleBetween3DCoords(t[18], t[19], t[20]) }),
        (s = Q(s, n)),
        s
      );
    }
  ...
  const Q = (e, t = p) => {
      ...
      return (
        ...
        (e[t + 'Wrist'].y = x(e[t + 'Wrist'].y * 2.3, t === p ? -1.2 : -0.6, t === p ? 0.6 : 1.6)),
          ...
          o.forEach((y) => {
            ...
            if (s === 'Thumb') {
              const z = {
                ...
                c = { x: 0, y: 0, z: 0 };
              (y === 'Proximal'
                ? ((c.z = x(h.z + a.z * -l * z.z * n, t === p ? -0.6 : -0.3, t === p ? 0.3 : 0.6)),
                  (c.x = x(h.x + a.z * -l * z.x, -0.6, 0.3)),
                  (c.y = x(h.y + a.z * -l * z.y * n, t === p ? -1 : -0.3, t === p ? 0.3 : 1)))
