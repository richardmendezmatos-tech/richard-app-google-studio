...
export declare type HandKeys<S extends Side> =
  `${S}${'Wrist' | 'RingProximal' | 'RingIntermediate' | 'RingDistal' | 'IndexProximal' | 'IndexIntermediate' | 'IndexDistal' | 'MiddleProximal' | 'MiddleIntermediate' | 'MiddleDistal' | 'ThumbProximal' | 'ThumbIntermediate' | 'ThumbDistal' | 'LittleProximal' | 'LittleIntermediate' | 'LittleDistal'}`;
