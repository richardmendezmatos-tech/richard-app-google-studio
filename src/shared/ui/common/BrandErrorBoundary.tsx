          ...
          <div className="z-10 max-w-2xl w-full bg-[#0a1625] border border-cyan-900/50 rounded-lg p-8 shadow-[0_0_50px_rgba(0,174,217,0.1)] relative">
            ...
            <div className="space-y-4 mb-8">
              ...
              <p className="text-sm text-cyan-400/80">
                El núcleo del sistema ha encontrado una anomalía inesperada. Los protocolos de
                seguridad han detenido la ejecución para proteger la integridad de los datos.
              </p>
            </div>
