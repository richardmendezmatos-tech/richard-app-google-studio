...
export const CREDIT_TIERS = {
  ...
  GOOD: { id: 'good', name: 'Bueno (660-719)', apr: 0.085, minProntoPercentage: 0.1 },
  FAIR: { id: 'fair', name: 'Regular (600-659)', apr: 0.1199, minProntoPercentage: 0.15 },
  POOR: { id: 'poor', name: 'Afectado (<600)', apr: 0.1599, minProntoPercentage: 0.2 },
};
