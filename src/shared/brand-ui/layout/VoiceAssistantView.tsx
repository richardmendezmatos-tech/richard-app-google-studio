...
import { useVoiceSession } from '@/features/ai/hooks/useVoiceSession';
import { useTelemetry } from '@/features/houston/hooks/useTelemetry';
        ...
        <div className="flex flex-col gap-2">
          ...
          {connectionState === 'connected' && (
            <motion.div
              ...
              className="flex items-center gap-2 text-[10px] font-mono text-[#00aed9] ml-2"
            >
          ...
          {connectionState === 'connected' && (
            ...
            >
              ...
              <div className="flex flex-col items-end bg-white/5 backdrop-blur-xl border border-white/10 p-3 rounded-2xl shadow-xl">
                ...
                <span className="text-sm font-mono text-[#00aed9]">{telemetry.quality}%</span>
              </div>
            </motion.div>
          )}
        </AnimatePresence>
      ...
      <div className="flex-1 flex items-center justify-center relative z-10 w-full min-h-[400px]">
        <div className="relative flex items-center justify-center">
          ...
          <motion.div
            ...
            className={`absolute w-[400px] h-[400px] border border-[#00aed9]/30 rounded-full ${isListening ? 'border-emerald-500/30' : ''}`}
          />
          <motion.div
            animate={{
            ...
            className={`absolute w-[300px] h-[300px] border border-[#00aed9]/40 rounded-full ${isListening ? 'border-emerald-500/40' : ''}`}
          />
          <motion.div
            animate={{
            ...
            className={`w-36 h-36 rounded-full bg-gradient-to-br from-[#00aed9] to-blue-700 flex items-center justify-center z-20 relative overflow-hidden ${isListening ? 'ring-4 ring-emerald-500/50' : ''}`}
          >
            {/* Inner AI Sparkle */}
        ...
        <div className="w-full relative">
          ...
          >
            {transcriptions.length === 0 && connectionState === 'connected' && (
              ...
              >
                <Activity size={24} className="animate-pulse text-[#00aed9]/50" />
                  ...
                  <div
                    className={`max-w-[75%] p-4 rounded-3xl shadow-lg backdrop-blur-xl border ${
                      t.role === 'user'
                        ...
                        : 'bg-[#00aed9]/15 text-[#00aed9] rounded-bl-sm border-[#00aed9]/20'
                    }`}
                  >
