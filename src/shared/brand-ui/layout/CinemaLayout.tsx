...
import Sidebar from '@/shared/brand-ui/layout/Sidebar';
import ReloadPrompt from '@/shared/brand-ui/layout/ReloadPrompt';
import OfflineIndicator from '@/shared/brand-ui/layout/OfflineIndicator';
...
const WhatsAppFloat = lazy(() =>
  import('@/features/leads/components/WhatsAppFloat').then((mod) => ({
    default: mod.WhatsAppFloat,
  })),
);
