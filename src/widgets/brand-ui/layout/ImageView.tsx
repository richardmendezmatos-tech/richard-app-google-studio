...
import { generateImage } from '@/features/ai-agents';
      ...
      <div className="bg-slate-800/50 p-6 rounded-3xl border border-slate-700 shadow-2xl backdrop-blur-sm">
        ...
        <div className="flex flex-col md:flex-row gap-4">
          <textarea
            ...
            className="flex-1 bg-slate-900 border border-slate-700 rounded-xl p-4 text-slate-100 focus:ring-2 focus:ring-primary outline-none min-h-[100px] resize-none"
          />
          <button
            onClick={handleGenerate}
            disabled={loading || !prompt.trim()}
            className="md:w-32 bg-primary hover:bg-cyan-500 disabled:opacity-50 text-white rounded-xl font-bold transition-all shadow-lg flex items-center justify-center gap-2"
          >
            {loading ? (
              ...
              <div className="flex gap-2">
                ...
                {onSearchSimilar && (
                  <button
                    ...
                    className="flex-1 bg-primary hover:bg-cyan-500 text-white py-2 rounded-lg text-[10px] uppercase font-bold tracking-widest flex items-center justify-center gap-1 transition-colors shadow-lg"
