...
import { generateCode } from '@/features/ai-agents';
    ...
    <div className="p-4 lg:p-8 max-w-6xl mx-auto w-full flex flex-col lg:flex-row gap-6 h-full min-h-0">
      <div className="flex-1 flex flex-col min-h-[400px]">
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              className="px-3 py-1.5 bg-primary hover:bg-cyan-500 rounded-lg text-xs font-semibold text-white shadow-lg"
            >
              Optimizar
            </button>
          </div>
        ...
        <textarea
          ...
          className="flex-1 bg-slate-950 border border-slate-800 rounded-xl p-6 font-mono text-sm text-cyan-300 focus:ring-2 focus:ring-primary outline-none resize-none shadow-inner"
        />
      </div>
