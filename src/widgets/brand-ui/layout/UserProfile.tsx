      ...
      <div className="max-w-4xl w-full space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-slate-500 dark:text-slate-400">
            Gestiona tu identidad y seguridad personal.
          </p>
        </div>
            ...
            <div className="bg-white dark:bg-slate-900 rounded-[30px] p-8 shadow-xl border border-slate-100 dark:border-slate-800 flex flex-col items-center relative overflow-hidden group">
              ...
              <div className="relative mb-6">
                ...
                <button
                  ...
                  className="absolute bottom-0 right-0 z-20 bg-primary text-white p-2 rounded-full shadow-lg hover:scale-110 transition-transform"
              ...
              <p className="text-xs font-bold text-primary uppercase tracking-widest bg-primary/10 px-3 py-1 rounded-full mb-6">
              ...
              <form onSubmit={handleUpdateProfile} className="flex gap-4 items-end">
                <div className="flex-1 space-y-2">
                  ...
                  <input
                    ...
                    className="w-full bg-slate-50 dark:bg-slate-950 border-none rounded-2xl px-5 py-4 font-semibold text-slate-700 dark:text-white focus:ring-2 focus:ring-primary outline-none transition-all"
                ...
                <button
                  ...
                  className="h-[56px] px-8 bg-[#0d2232] text-white rounded-2xl font-bold uppercase tracking-wider hover:bg-primary disabled:opacity-50 disabled:hover:bg-[#0d2232] transition-colors"
                >
              ...
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-500">
                    Cambiar contraseña y seguridad de cuenta.
                  </p>
                </div>
              </div>
...
const PrivacyToggleInProfile: React.FC<{
  label: string;
  description: string;
  enabled: boolean;
  ...
  return (
    <div className="flex items-center justify-between gap-4 p-4 bg-slate-50 dark:bg-slate-950 rounded-2xl border border-slate-100 dark:border-slate-800 transition-all hover:border-primary/30">
      <div className="flex-1">
