...
import { generateBlogPost } from '@/features/ai-agents';
                ...
                <div className="max-w-2xl mx-auto space-y-12 pb-12">
                  ...
                  <div className="bg-slate-50 dark:bg-slate-900/50 p-10 rounded-[40px] border border-slate-100 dark:border-slate-800/50 text-center space-y-6">
                    ...
                    <div className="flex justify-center gap-4">
                      <button className="px-8 py-3 bg-primary text-white rounded-full font-black text-[10px] uppercase tracking-widest shadow-xl shadow-primary/20 hover:scale-105 transition-all">
                        Yes, I loved it
                      </button>
