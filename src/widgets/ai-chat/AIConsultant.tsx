      ...
      <div className="flex-1 max-w-4xl mx-auto w-full flex flex-col bg-white dark:bg-slate-800 lg:rounded-[40px] shadow-2xl dark:shadow-none border border-slate-100 dark:border-slate-700 overflow-hidden">
        ...
        <div className="p-8 bg-[#173d57] dark:bg-slate-900/50 text-white flex items-center justify-between">
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 bg-primary rounded-2xl flex items-center justify-center shadow-lg shadow-cyan-500/30">
                ...
                <div
                  className={`w-10 h-10 rounded-xl flex items-center justify-center shrink-0 ${
                    msg.role === 'user'
                      ...
                      : 'bg-cyan-50 dark:bg-cyan-500/10 text-primary'
                  }`}
                >
        ...
        <div className="p-6 bg-slate-50 dark:bg-slate-800/50 border-t border-slate-100 dark:border-slate-700">
          <div className="relative group">
            <input
              ...
              className="w-full bg-white dark:bg-slate-700 border-2 border-slate-200 dark:border-slate-600 rounded-[28px] py-5 pl-8 pr-16 text-lg dark:text-white focus:border-primary focus:ring-0 outline-none transition-all shadow-inner"
            ...
            <button
              ...
              className="absolute right-3 top-1/2 -translate-y-1/2 w-12 h-12 bg-[#173d57] text-white rounded-full flex items-center justify-center hover:bg-primary disabled:opacity-30 transition-all shadow-lg"
            >
              <Send size={20} />
            </button>
          </div>
