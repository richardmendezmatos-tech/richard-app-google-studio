  ...
  return (
    ...
    >
      <div
        {...attributes}
        {...listeners}
        className="cursor-grab active:cursor-grabbing text-slate-600 hover:text-primary"
      >
      ...
      <div className="text-sm font-black text-primary">${car.price.toLocaleString()}</div>
    </div>
  );
};
