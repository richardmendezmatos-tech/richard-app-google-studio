...
import { useAdminPanelState } from '@/features/admin/hooks/useAdminPanelState';
...
const AILabView = React.lazy(() => import('@/widgets/ai-chat/AILabView'));
        ...
        <main className="animate-in fade-in zoom-in-95 duration-300 min-h-[600px]">
          <BrandErrorBoundary>
            ...
            {state.activeTab === 'marketing' && (
              <Suspense fallback={<div className="p-20 text-center animate-pulse text-primary font-black uppercase tracking-widest">Inicializando Engine Semántico...</div>}>
                <MarketingTabView 
                  inventory={inventory} 
            ...
            {state.activeTab === 'security' && (
              <Suspense fallback={<div className="p-20 text-center animate-pulse text-primary font-black uppercase tracking-widest">Bóveda Criptográfica...</div>}>
                <SecurityTabView />
              </Suspense>
            )}
