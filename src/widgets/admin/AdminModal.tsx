    ...
    try {
      ...
      if (uploadResults.length > 0) {
        try {
          ...
          logDebug('AI Vision: Imagen cargada para análisis directo.');
        } catch (imgError) {
        ...
        <div className="flex-1 overflow-hidden flex flex-col lg:flex-row">
          ...
          <div className="w-full lg:w-1/2 p-8 bg-slate-950/30 border-r border-white/5 overflow-y-auto custom-scrollbar">
            <div className="space-y-6">
              ...
              <div className="p-6 rounded-4xl bg-linear-to-br from-primary/10 to-transparent border border-primary/20 relative overflow-hidden group">
            ...
            <form ref={formRef} onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="space-y-3 group">
                ...
                <textarea
                  ...
                  rows={4}
                  className="w-full p-5 bg-slate-900/50 rounded-4xl font-medium outline-none border border-white/5 focus:bg-slate-900 focus:border-primary/50 focus:shadow-[0_0_15px_rgba(0,174,217,0.15)] transition-all text-white placeholder:text-slate-600 resize-none"
              ...
              {debugLogs.length > 0 && (
                <div className="p-5 bg-black/50 rounded-4xl border border-rose-500/20 space-y-2 backdrop-blur-md">
              ...
              <div className="pt-2">
                <button
                  ...
                  className="w-full h-[64px] bg-linear-to-r from-primary/80 to-purple-600/80 hover:from-primary hover:to-purple-500 text-white rounded-4xl font-black uppercase tracking-widest hover:scale-[1.02] active:scale-95 transition-all shadow-[0_0_20px_rgba(0,174,217,0.3)] hover:shadow-[0_0_30px_rgba(0,174,217,0.5)] disabled:opacity-50 flex items-center justify-center gap-3 border border-white/10"
                >
                  {isUploading ? (
                    <>
