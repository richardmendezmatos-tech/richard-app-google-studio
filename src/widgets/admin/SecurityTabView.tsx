...
export const SecurityTabView: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      <div className="bg-slate-900/40 backdrop-blur-xl p-8 rounded-4xl shadow-2xl border border-white/10 flex flex-col md:flex-row items-center justify-between gap-6 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center md:items-start text-center md:text-left">
          ...
          <p className="text-slate-400 text-sm mt-3 max-w-md">
            Implementa login sin contraseña (passwordless) utilizando la seguridad biométrica de tu
            dispositivo actual (FaceID / TouchID).
          </p>
        </div>
      ...
      <div className="min-h-[600px] relative">
        <div className="absolute inset-0 bg-slate-900/40 backdrop-blur-xl rounded-4xl border border-white/10 pointer-events-none" />
        <div className="relative z-10">
          <Suspense
            fallback={
              <div className="p-12 text-center text-slate-500 animate-pulse font-bold tracking-widest uppercase">
