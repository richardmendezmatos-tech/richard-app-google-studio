    ...
    >
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-1">
          {[1, 2, 3].map((i) => (
            <div
              key={i}
              className="w-1.5 h-1.5 rounded-full bg-cyan-500/40 animate-pulse"
      ...
      <div className="grid grid-cols-2 gap-4">
        {metrics.map((metric, idx) => (
          <div
            key={idx}
            className="p-3 bg-white/[0.03] border border-white/[0.05] rounded-xl hover:bg-white/[0.06] transition-all group"
          >
