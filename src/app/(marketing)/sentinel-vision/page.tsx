...
export const metadata: Metadata = {
  ...
  description: 'Military-grade AI automotive scanner. Analyze your vehicle with neural vision technology.',
};
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <section className="mt-32 grid grid-cols-1 md:grid-cols-3 gap-12 border-t border-white/5 pt-20">
          <div className="space-y-4">
            ...
            <h4 className="text-xl font-bold text-white uppercase tracking-tighter-caps">Neural Decoding</h4>
            <p className="text-text-muted text-sm leading-relaxed">
              Our advanced AI architecture identifies over 2,000 vehicle parameters from a single high-resolution capture.
            </p>
          </div>
          <div className="space-y-4">
            ...
            <h4 className="text-xl font-bold text-white uppercase tracking-tighter-caps">Market Pulse Integration</h4>
            <p className="text-text-muted text-sm leading-relaxed">
              Real-time cross-referencing with global auction data and local market inventory for precision valuation.
            </p>
          </div>
          <div className="space-y-4">
            ...
            <h4 className="text-xl font-bold text-white uppercase tracking-tighter-caps">Sentinel Verification</h4>
            <p className="text-text-muted text-sm leading-relaxed">
              Every scan is cryptographically signed and verified by the Richard Automotive Command Center.
            </p>
          </div>
        </section>
      </div>
