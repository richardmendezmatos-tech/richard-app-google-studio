...
const TrustBar = dynamic(() => import('@/features/inventory/ui/storefront/TrustBar'), {
  ssr: true,
  loading: () => <div className="min-h-[500px] bg-slate-900/20 animate-pulse rounded-3xl mx-6" />,
});
const FAQSection = dynamic(() => import('@/shared/ui/components/FAQSection'), {
  ssr: true,
  loading: () => <div className="min-h-[500px] bg-slate-900/20 animate-pulse rounded-3xl mx-6" />,
});
const TestimonialsSection = dynamic(() => import('@/features/inventory/ui/storefront/TestimonialsSection'), {
  ssr: true,
  loading: () => <div className="min-h-[500px] bg-slate-900/20 animate-pulse rounded-3xl mx-6" />,
});
