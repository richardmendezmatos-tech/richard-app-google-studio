...
const ComparisonBar = React.lazy(() =>
  import('@/widgets/comparison/ComparisonBar').then((m) => ({ default: m.default || m })),
);
const PrivacyBanner = React.lazy(() =>
  import('@/features/privacy/components/PrivacyBanner').then((m) => ({ default: m.default || m })),
);
