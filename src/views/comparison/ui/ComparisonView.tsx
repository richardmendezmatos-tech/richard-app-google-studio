  ...
  return (
    <div className="min-h-screen bg-[#0d2232] text-white relative">
      ...
      <header className="p-8 relative z-10 flex justify-between items-center">
        ...
        <div className="flex gap-4">
          <button
            ...
            className="px-4 py-2 text-xs font-bold uppercase tracking-widest text-primary border border-primary/30 rounded-lg hover:bg-primary/10"
          >
            Limpiar Todo
          </button>
        </div>
      ...
      <main className="p-8 relative z-10 max-w-[1800px] mx-auto pb-24">
        ...
        {/* VERDICT CARD */}
        {verdict && (
          <div className="bg-linear-to-r from-slate-900 to-slate-800 border border-primary/30 rounded-4xl p-8 mb-12 relative overflow-hidden shadow-2xl shadow-cyan-900/20">
              ...
              >
                {isWinner && (
                  <div className="absolute -top-4 inset-x-0 flex justify-center z-20">
                    <span className="px-4 py-1 bg-primary text-white text-[10px] font-black uppercase tracking-widest rounded-full shadow-lg flex items-center gap-1">
                ...
                {/* Car Header */}
                <div
                  className={`bg-slate-800 rounded-t-3xl p-6 relative overflow-hidden ${isWinner ? 'border-2 border-primary' : 'border border-white/5'}`}
                >
                  <button
                ...
                {/* Specs */}
                <div
                  className={`bg-slate-900/50 rounded-b-3xl p-6 space-y-4 border-x border-b ${isWinner ? 'border-primary bg-primary/5' : 'border-white/5'}`}
                >
