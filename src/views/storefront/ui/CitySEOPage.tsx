...
const cities: Record<string, CityConfig> = {
  guaynabo: {
    ...
    keywords: [
      ...
      'venta de autos premium guaynabo',
    ],
  ...
  'vega-alta': {
    ...
    keywords: [
      ...
      'carros baratos vega alta',
      'financiamiento autos vega alta',
    ],
  ...
  bayamon: {
    ...
    keywords: [
      ...
      'carros usados certificados bayamon',
    ],
          ...
          >
            <div className="inline-flex items-center gap-2 bg-cyan-500/10 border border-cyan-500/20 rounded-full px-5 py-2 mb-8">
              ...
              <span className="text-xs font-black text-cyan-400 uppercase tracking-[0.3em]">
                Richard Automotive — {config.name}
              </span>
            </div>
            ...
            <p className="text-xl text-slate-300 max-w-2xl mb-12 font-medium leading-relaxed">
              Elevamos la experiencia de compra en {config.name}.{' '}
              {config.landmark ? `Desde ${config.landmark} hasta tu hogar` : 'Calidad certificada'},
              descubre por qué somos el dealer #1 de autos premium en Puerto Rico.
            </p>
          ...
          {[
            {
              ...
              desc: 'Cada unidad es sometida a una inspección rigurosa de 150 puntos.',
            },
            {
              icon: ShieldCheck,
              title: 'Garantía Richard',
              desc: 'Protección y respaldo total en cada venta realizada en la zona metro.',
            },
            {
              icon: Zap,
              title: 'Entrega en 24h',
              desc:
                'Si estás en ' + config.name + ', te entregamos el auto en la puerta de tu casa.',
            },
          ].map((item, i) => (
            <div
              key={i}
      ...
      <section className="py-32 px-6 text-center relative overflow-hidden">
        ...
        <div className="relative z-10">
          <h2 className="text-4xl md:text-6xl font-black tracking-tight mb-8">
            ¿Listo para conducir el auto de tus sueños?
          </h2>
          <Link
            to="/financiamiento"
