  ...
  return (
    <div className="min-h-screen relative flex items-center justify-center p-6 bg-[#0a1118] overflow-hidden">
      ...
      <motion.div
        ...
        className="relative w-full max-w-md bg-slate-900/40 backdrop-blur-xl rounded-4xl border border-white/5 shadow-2xl overflow-hidden z-10"
      >
        <div className="pt-10 pb-6 px-10 text-center relative">
          <motion.div
            whileHover={{ scale: 1.05, rotate: 5 }}
            className="inline-flex items-center justify-center w-20 h-20 rounded-4xl mb-6 shadow-xl bg-linear-to-br from-cyan-500/20 to-blue-600/20 border border-cyan-500/30 text-cyan-400"
          >
