...
export const initialInventoryData: Omit<Car, 'id'>[] = [
  ...
  },
  {
    ...
    type: 'luxury',
    badge: 'In Stock',
    image: '/inventory/ford/mustang-mache.webp',
    status: 'available',
    featured: true,
  },
  {
    ...
    image: '/inventory/ford/f150-raptor.webp',
    status: 'available',
    featured: true,
  },
  {
    ...
    image: '/inventory/ford/ranger-raptor.webp',
    status: 'available',
    featured: false,
  },
  {
    ...
    type: 'suv',
    badge: 'New Arrival',
    image: '/inventory/ford/explorer-st.webp',
    status: 'available',
    featured: true,
  },
  {
    name: '2026 Ford Bronco Heritage',
    make: 'Ford',
    ...
    image: '/inventory/ford/bronco-heritage.webp',
    status: 'available',
    featured: false,
  },
  {
