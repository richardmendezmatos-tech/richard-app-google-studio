...
const AdminPanel = React.lazy(() =>
  lazyRetry(() => import('@/features/admin/components/AdminPanel')),
) as unknown as React.ComponentType<AdminPanelProps>;
...
const DigitalGarage = React.lazy(() =>
  lazyRetry(() => import('@/components/layout/DigitalGarage')),
...
const FrameworkDashboard = React.lazy(() =>
  lazyRetry(() => import('@/components/layout/FrameworkDashboard')),
);
const BetaOnboard = React.lazy(() =>
  lazyRetry(() => import('@/features/admin/components/BetaOnboard')),
);
const EarlyAdopterOnboard = React.lazy(() =>
  lazyRetry(() => import('@/features/admin/components/EarlyAdopterOnboard')),
);
const B2BBillingDashboard = React.lazy(() =>
  lazyRetry(() => import('@/features/admin/components/B2BBillingDashboard')),
);
...
const CRMBoard = React.lazy(() =>
  lazyRetry(() => import('@/features/admin/components/CRMBoard')),
