...
const AnimeDemo: React.FC = () => {
  ...
  return (
    ...
    >
      <div ref={boxRef} className="w-16 h-16 bg-red-500 mb-8 shadow-lg origin-center" />

      <h2 ref={textRef} className="text-2xl font-bold text-white tracking-widest uppercase mb-4">
        AnimeJS v4 Integrated
      </h2>

      <p className="text-slate-400 text-sm max-w-md text-center">
        Esta es una demostración de una línea de tiempo (timeline) usando AnimeJS v4 con
