          ...
          <div className="space-y-12">
            ...
            <div className="grid gap-4 max-w-4xl">
              ...
              {tradeIns.map((offer) => (
                <div
                  key={offer.id}
                  className="bg-slate-800/50 p-6 rounded-2xl border border-white/5 flex items-center justify-between group hover:border-[#00aed9]/30 transition-colors"
                >
                  <div>
                    <div className="flex items-center gap-3 mb-1">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            <h1 className="text-4xl font-black uppercase tracking-tighter">
              Mi Garaje <span className="text-[#00aed9]">Digital</span>
            </h1>
