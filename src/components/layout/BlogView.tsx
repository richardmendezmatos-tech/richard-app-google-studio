          ...
          <div className="p-6 space-y-6">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                <label className="text-[10px] font-bold uppercase tracking-widest text-[#00aed9]/60">
                  Editorial Tone
                </label>
                <div className="flex bg-slate-100 dark:bg-slate-900/50 rounded-xl p-1 relative">
                  {TONE_OPTIONS.map((t) => (
                    ...
                    >
                      <span
                        className={tone === t ? 'text-[#00aed9] dark:text-white' : 'text-slate-400'}
                      >
                        {t === 'hype' ? '🔥' : t.slice(0, 4)}
                      </span>
                      {tone === t && (
                ...
                <div className="flex-1 p-8 lg:p-12 flex flex-col justify-center space-y-6">
                  <div className="flex items-center gap-6 text-[10px] text-slate-400 font-bold uppercase tracking-widest">
                    <span className="flex items-center gap-2">
                      <Calendar size={12} className="text-[#00aed9]" /> {post.date}
                    </span>
                  ...
                  <div className="flex items-center justify-between pt-4 border-t border-slate-100 dark:border-slate-800/50">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-xs font-bold text-slate-700 dark:text-slate-200 underline decoration-[#00aed9]/30">
                        {post.author}
                      </span>
                    </div>
            ...
            <div className="p-8 space-y-6">
              ...
              <div className="flex flex-wrap gap-2">
                {[
                  ...
                  <button
                    key={tag}
                    className="px-5 py-2.5 bg-slate-100 dark:bg-slate-800/50 text-slate-500 dark:text-slate-400 rounded-2xl text-[10px] font-black uppercase tracking-widest hover:bg-[#00aed9] hover:text-white hover:shadow-lg hover:shadow-[#00aed9]/20 transition-all"
                  >
                    #{tag}
                  </button>
                ))}
                ...
                <div className="absolute bottom-12 left-12 right-12 space-y-4">
                  <div className="flex gap-2">
                    {selectedPost.tags.map((tag) => (
                      <span
                        key={tag}
                        className="px-3 py-1 bg-[#00aed9] text-white text-[9px] font-black uppercase tracking-widest rounded-full"
                      >
                        {tag}
                      </span>
                    ))}
                ...
                <div className="max-w-2xl mx-auto space-y-12 pb-12">
                  <div className="flex items-center justify-between py-6 border-b border-slate-100 dark:border-slate-800/50">
                    <div className="flex items-center gap-4">
                      <div className="w-12 h-12 rounded-2xl bg-slate-100 dark:bg-slate-800 flex items-center justify-center font-black text-[#00aed9]">
                        RA
                      </div>
                      <div>
                    ...
                    <div
                      ...
                      dangerouslySetInnerHTML={{
                        __html: selectedPost.content
                          ...
                          .replace(
                            /## (.*)/g,
                            '<h2 class="text-3xl font-black mt-12 mb-6 text-slate-800 dark:text-white uppercase tracking-tighter border-b border-[#00aed9]/20 pb-2">$1</h2>',
                          ),
                      }}
                    />
                  </div>
                  ...
                  <div className="bg-slate-50 dark:bg-slate-900/50 p-10 rounded-[40px] border border-slate-100 dark:border-slate-800/50 text-center space-y-6">
                    ...
                    <div className="flex justify-center gap-4">
                      <button className="px-8 py-3 bg-[#00aed9] text-white rounded-full font-black text-[10px] uppercase tracking-widest shadow-xl shadow-[#00aed9]/20 hover:scale-105 transition-all">
                        Yes, I loved it
                      </button>
