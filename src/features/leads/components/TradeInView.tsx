          ...
          <div className="space-y-6 animate-in fade-in slide-in-from-right duration-500">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                <label className="text-xs font-bold uppercase tracking-widest text-[#00aed9]">
                  Año
                </label>
                <select
          ...
          <div className="space-y-6 animate-in fade-in slide-in-from-right duration-500">
            <div className="grid grid-cols-1 gap-4">
              {[
                ...
                >
                  <h4
                    className={`text-lg font-bold ${formData.condition === c.id ? 'text-[#00aed9]' : 'text-white'}`}
                  >
                    {c.label}
                  </h4>
        ...
        return (
          <div className="text-center animate-in zoom-in duration-500 space-y-8 py-8">
            ...
            <div className="flex flex-col md:flex-row gap-4 justify-center max-w-md mx-auto">
              <button
                onClick={() => {}}
                className="flex-1 py-4 bg-[#00aed9] hover:bg-[#009ac0] text-slate-900 font-bold rounded-xl shadow-lg shadow-cyan-500/20 transition-all"
              >
                Aplicar a Compra
              </button>
              <button
          ...
          <div className="mb-12 text-center space-y-4">
            ...
            <div className="flex justify-center gap-2 mt-8">
              {['identify', 'details', 'condition'].map((s, i) => (
                <div
                  key={s}
                  className={`h-1 w-12 rounded-full transition-all duration-300 ${['identify', 'details', 'condition'].indexOf(step) >= i ? 'bg-[#00aed9]' : 'bg-slate-800'}`}
                />
              ))}
            </div>
          </div>
