      ...
      <div className="min-h-screen bg-[#0d2232] flex items-center justify-center p-6 relative overflow-hidden">
        ...
        <div className="bg-slate-900/90 backdrop-blur-xl p-12 rounded-[40px] shadow-[0_0_60px_rgba(0,174,217,0.1)] text-center max-w-lg w-full border border-white/10 animate-in zoom-in duration-500 relative z-10">
          ...
          <p className="text-slate-300 mb-8 leading-relaxed font-light">
            ...
            <span className="text-[#00aed9] font-bold">Expertos Financieros</span>
          ...
          <div className="w-full max-w-2xl">
            ...
            <div className="flex gap-2 mb-8">
              {[1, 2, 3, 4, 5].map((i) => (
                <div
                  key={i}
                  className={`h-1.5 flex-1 rounded-full transition-all duration-500 ${step >= i ? 'bg-[#00aed9] shadow-[0_0_10px_#00aed9]' : 'bg-slate-800'}`}
                />
              ))}
            </div>
            ...
            <div className="bg-[#131f2a] p-8 md:p-10 rounded-[30px] border border-white/5 shadow-2xl relative overflow-hidden">
              ...
              {step === 1 && (
                <div className="space-y-6 animate-in slide-in-from-right duration-500">
                  ...
                  <div className="bg-[#00aed9]/5 border border-[#00aed9]/10 p-4 rounded-xl">
                    <p className="text-[10px] text-[#00aed9] uppercase font-bold tracking-widest text-center">
              ...
              {step === 5 && (
                <div className="space-y-6 animate-in slide-in-from-right duration-500">
                  ...
                  >
                    <div
                      className={`w-6 h-6 rounded border flex items-center justify-center shrink-0 mt-0.5 transition-colors ${formData.creditAuth ? 'bg-[#00aed9] border-[#00aed9]' : 'border-slate-600'}`}
                    >
