...
import type { Lead } from '@/shared/types/types';
...
vi.mock('@/shared/api/adapters/leads/crmService', () => ({
  updateLead: updateLeadMock,
}));

vi.mock('@/features/leads/services/whatsappService', () => ({
  whatsappService: {
    sendMessage: sendWhatsAppMock,
  },
}));

vi.mock('@/shared/api/communications/emailService', () => ({
  sendTransactionalEmail: sendTransactionalEmailMock,
}));

vi.mock('@/features/omnichannel/api/antigravityOmnichannelService', () => ({
