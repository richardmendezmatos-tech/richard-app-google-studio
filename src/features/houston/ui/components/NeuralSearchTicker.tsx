          ...
          <div>
            ...
            <div className="flex items-center gap-2 mt-0.5">
              ...
              <p className="text-[8px] text-slate-500 font-bold uppercase tracking-widest leading-none">
                Intelligence Engine N24 Active
              </p>
            </div>
          </div>
        </div>
            ...
            >
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <span className="text-xs font-black text-white italic tracking-tight group-hover/card:text-violet-300 transition-colors uppercase">
                      "{opp.query}"
                    </span>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <TrendingUp
                    size={14}
                    className="text-violet-400 group-hover/card:translate-x-1 group-hover/card:-translate-y-1 transition-transform"
                  />
                </div>
              </div>
                      ...
                      <div className="p-3 bg-violet-400/5 rounded-xl border border-violet-400/10">
                        <div className="flex items-center gap-2 mb-1.5">
                          ...
                          <span className="text-[9px] font-black text-violet-400 uppercase tracking-widest">
                            N24 Strategic Advice
                          </span>
                        </div>
                        <p className="text-[11px] leading-relaxed text-slate-300 font-medium">
                          {opp.recommendation}{' '}
                          <span className="text-slate-500 italic block mt-1">{opp.reason}</span>
                        </p>
                      </div>
