...
const HoustonDashboard: React.FC = () => {
  ...
  const identifyOutreachOpportunities = useMemo(
    () => container.getIdentifyOutreachOpportunitiesUseCase(),
    [],
  );
          ...
          >
            ...
            <div className="relative z-10 w-full">
              ...
              <div className="mt-12 grid grid-cols-4 gap-8">
                <div className="p-5 bg-white/[0.03] rounded-3xl border border-white/5 hover:bg-white/[0.05] transition-all hover:translate-y-[-4px] group">
          ...
          >
            ...
            <div className="space-y-10">
              ...
              <div className="grid grid-cols-2 gap-5">
                <div className="p-5 bg-white/[0.03] border border-white/5 rounded-3xl group/sub hover:bg-white/[0.05] transition-all hover:scale-[1.02]">
              ...
              {opportunities.length > 0 ? (
                opportunities.map((opp, idx) => (
                  <motion.div
                    ...
                    className="p-5 border border-white/5 rounded-3xl bg-white/[0.02] group/opp relative hover:bg-white/[0.05] transition-all cursor-pointer overflow-hidden"
                  >
                ...
                <div className="p-6 border border-white/5 rounded-3xl bg-white/[0.01] flex flex-col items-center justify-center py-12 gap-4">
