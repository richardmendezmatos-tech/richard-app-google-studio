      ...
      <div className="p-6 md:p-8 space-y-6 flex-1 flex flex-col relative z-20 bg-gradient-to-t from-slate-900/90 to-transparent">
        <div>
          ...
          <div className="flex items-center gap-2 text-[10px] font-bold text-slate-400 uppercase tracking-widest">
            <Gauge size={12} className="text-[#00aed9]" /> {car.type === 'luxury' ? 'Premium Trim' : 'Standard Trim'} •{' '}
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="bg-slate-950/50 p-4 rounded-2xl border border-white/5 space-y-1 shadow-inner group-hover:border-[#00aed9]/30 transition-colors duration-500">
        ...
        {car.features && car.features.length > 0 && (
          <div className="flex flex-wrap gap-2 mt-auto pt-2">
            {car.features.slice(0, 2).map((f, i) => (
              ...
              >
                <Tag size={10} className="text-[#00aed9]" /> {f}
              </span>
            ))}
          </div>
        )}
        ...
        <div className="flex gap-3 pt-4 mt-auto border-t border-white/5">
          <button
            ...
            className="flex-1 h-12 bg-[#00aed9]/10 text-[#00aed9] hover:bg-[#00aed9] hover:text-white rounded-xl text-[10px] font-black uppercase tracking-[0.2em] transition-all duration-300 flex items-center justify-center gap-2 group/btn border border-[#00aed9]/20 hover:shadow-[0_0_20px_rgba(0,174,217,0.4)]"
          >
