  ...
  return (
    <div className="space-y-6">
      <div className="bg-slate-900/40 backdrop-blur-xl p-8 rounded-[2rem] shadow-2xl border border-white/10 flex flex-col md:flex-row items-center justify-between gap-6 relative overflow-hidden">
        <div className="absolute top-0 right-0 w-full h-full bg-gradient-to-r from-transparent via-[#00aed9]/5 to-transparent pointer-events-none" />
        
        <div className="relative z-10 flex flex-col items-center md:items-start text-center md:text-left">
          <h3 className="text-xl font-black flex items-center gap-3 text-white uppercase tracking-tight">
            <div className="p-3 bg-[#00aed9]/10 rounded-xl relative">
              <Key className="text-[#00aed9] relative z-10" size={24} />
              <div className="absolute inset-0 bg-[#00aed9]/20 blur-xl rounded-full" />
            </div>
        ...
        <button
          ...
          className="relative group px-8 py-4 bg-[#00aed9]/10 text-[#00aed9] border border-[#00aed9]/30 rounded-xl font-black text-sm uppercase tracking-widest transition-all hover:bg-[#00aed9] hover:text-white hover:shadow-[0_0_30px_rgba(0,174,217,0.4)] hover:-translate-y-1 flex items-center gap-3 z-10 overflow-hidden"
        >
