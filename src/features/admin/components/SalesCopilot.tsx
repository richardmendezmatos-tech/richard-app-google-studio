          ...
          return (
            ...
            >
              ...
              <div className="flex gap-3">
                ...
                <button className="flex-1 bg-[#00aed9] text-white font-bold h-12 rounded-xl flex items-center justify-center gap-2 transition-all text-[10px] uppercase tracking-widest shadow-lg shadow-cyan-500/20">
