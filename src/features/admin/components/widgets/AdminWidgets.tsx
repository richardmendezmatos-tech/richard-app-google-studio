...
export const StatusWidget = ({
  ...
  <div className="bg-slate-900/40 backdrop-blur-xl border border-white/5 p-6 rounded-4xl flex items-center gap-5 group cursor-default route-fade-in hover:-translate-y-1 hover:scale-[1.01] hover:bg-slate-800/60 transition-all duration-300">
    <div
    ...
    <div>
      ...
      <div className="text-3xl font-black text-white leading-none tracking-tighter shadow-none drop-shadow-[0_0_15px_rgba(255,255,255,0.1)]">
        {value}
      </div>
      {subValue && (
