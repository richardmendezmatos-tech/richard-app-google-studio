    ...
    <div className="min-h-screen bg-[#050b14] text-white flex items-center justify-center p-6">
      <div className="max-w-md w-full bg-slate-900 border border-purple-500/30 rounded-3xl p-8 shadow-2xl shadow-purple-900/20">
        ...
        <p className="text-slate-400 mb-8 text-sm leading-relaxed">
          Estás a punto de simular el alta de <strong>Elite Motors</strong>. Esto demostrará el
          aislamiento de datos y la capacidad de marca blanca instantánea.
        </p>
        ...
        <div className="space-y-4 mb-8">
          ...
          <div className="flex items-center gap-3 text-xs font-bold text-slate-500 uppercase">
            <Database size={14} /> ID de Base de Datos:{' '}
            <span className="text-white">elite-motors-beta</span>
          </div>
          <div className="flex items-center gap-3 text-xs font-bold text-slate-500 uppercase">
            <ShieldCheck size={14} /> Seguridad:{' '}
            <span className="text-emerald-500">Aislamiento Activo</span>
          </div>
        </div>
