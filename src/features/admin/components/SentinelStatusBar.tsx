        ...
        <div className="fixed bottom-0 left-0 right-0 z-[110] bg-slate-950/80 backdrop-blur-xl border-t border-white/5 h-8 flex items-center px-6 justify-between text-[9px] font-black uppercase tracking-[0.2em]">
            <div className="flex items-center gap-6">
                <div className="flex items-center gap-2 text-slate-500">
                    ...
                    <span>System Status: <span className={isUp ? 'text-emerald-400' : 'text-rose-400'}>{isUp ? 'Operational' : 'Anomaly Detected'}</span></span>
                </div>
                <div className="flex items-center gap-2 text-slate-500">
                    <Activity size={10} className="text-blue-500" />
                    <span>Latency: <span className="text-white">{latency}ms</span></span>
                </div>
            </div>
            ...
            <div className="flex items-center gap-6">
                <div className="flex items-center gap-2 text-slate-500">
                    ...
                    <span>RA-Voice: <span className="text-emerald-400">Executive Bridge Active</span></span>
                </div>
                <div className="flex items-center gap-2 text-slate-500">
                    <ShieldCheck size={10} className="text-[#00aed9]" />
