...
import {
  ...
  MarketingContent,
} from '@/features/leads/services/marketingService';
          ...
          <div className="flex items-center gap-6">
            ...
            <div>
              <div className="flex items-center gap-2 mb-1">
                <span className="px-2 py-0.5 rounded-full bg-[#00aed9]/10 text-[#00aed9] text-[9px] font-black uppercase tracking-widest border border-[#00aed9]/20">
                  AI Engine 2.0
                </span>
          ...
          {loading ? (
            <div className="h-full flex flex-col items-center justify-center py-20 space-y-6">
              <div className="relative">
                ...
                <Sparkles
                  className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-[#00aed9]/50 animate-pulse"
                  size={24}
                />
              </div>
                ...
                <div className="lg:col-span-5 space-y-6">
                  <div className="group relative rounded-[40px] overflow-hidden border border-white/10 shadow-2xl bg-black">
                    ...
                    <div className="absolute bottom-10 left-10 right-10">
                      ...
                      <p className="text-lg font-bold text-[#00aed9] tracking-tight uppercase">
                    ...
                    <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-500">
                      ...
                      <div className="bg-white/[0.03] p-8 rounded-[38px] border border-white/5 space-y-6 hover:border-[#00aed9]/20 transition-all duration-300">
                        ...
                        <div className="p-6 bg-white/5 rounded-3xl border border-white/10 border-dashed italic">
                          <p className="text-sm text-[#00aed9] whitespace-pre-wrap leading-relaxed font-bold uppercase tracking-wide">
