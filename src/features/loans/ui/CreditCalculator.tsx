      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <h2 className="text-3xl md:text-5xl font-black tracking-tight mb-6 leading-tight">
            Diseña tu Plan de
            <br />
            <span className="bg-linear-to-r from-cyan-400 to-purple-400 bg-clip-text text-transparent italic">
              Financiamiento
            </span>
          </h2>
        ...
        <div className="bg-slate-900/50 backdrop-blur-xl border border-white/5 rounded-5xl p-8 lg:p-10 shadow-2xl relative overflow-hidden">
          {/* Result Display */}
          <div className="text-center mb-10 p-6 bg-linear-to-b from-white/5 to-transparent rounded-4xl border border-white/5">
