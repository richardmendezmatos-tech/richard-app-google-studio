        ...
        <div className="p-8 pt-2">
          ...
          {!preview && !isAnalyzing && (
            <div className="mt-6 flex flex-wrap gap-2 justify-center">
              <span className="px-3 py-1 bg-slate-100 dark:bg-slate-800 rounded-lg text-[10px] font-bold text-slate-500 uppercase tracking-wide border border-slate-200 dark:border-slate-700">
                📸 Foto de la calle
              </span>
              <span className="px-3 py-1 bg-slate-100 dark:bg-slate-800 rounded-lg text-[10px] font-bold text-slate-500 uppercase tracking-wide border border-slate-200 dark:border-slate-700">
                🖼️ Screenshot
