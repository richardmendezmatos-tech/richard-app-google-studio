  ...
  return (
    ...
    >
      <div className="bg-slate-50 dark:bg-slate-900 w-full max-w-6xl h-[90vh] rounded-[40px] md:rounded-[60px] shadow-2xl p-4 md:p-6 relative flex flex-col lg:flex-row gap-6 overflow-hidden">
        ...
        {/* Left Side: Image */}
        <div className="w-full lg:w-3/5 h-1/3 lg:h-full bg-white dark:bg-slate-800 rounded-[35px] lg:rounded-[45px] flex items-center justify-center relative overflow-hidden group border border-slate-200 dark:border-slate-700">
          <Viewer360
        ...
        <div className="w-full lg:w-2/5 flex flex-col h-full overflow-hidden">
          ...
          <div className="mb-6 px-2">
            ...
            <h2
              id="car-modal-title"
              className="text-3xl lg:text-4xl font-black text-slate-800 dark:text-white tracking-tighter leading-tight mt-1"
            >
              {car.name}
            </h2>
          ...
          <div className="bg-white dark:bg-slate-800 p-6 lg:p-8 rounded-[35px] text-center shadow-lg dark:shadow-none border border-slate-100 dark:border-slate-700 mb-6 shrink-0 transition-all">
            ...
            {/* Recommendation #3: Progress Rings in Modal */}
            <div className="flex justify-around mt-4 pt-4 border-t border-slate-100 dark:border-slate-700">
              <ProgressRing
                label="HP"
          ...
          <div className="flex-1 overflow-y-auto pr-2 custom-scrollbar">
            {activeTab === 'calculator' ? (
              <div
                id="calculator-form"
                className="space-y-6 pb-4 animate-in fade-in slide-in-from-bottom-2"
              >
                {/* Inputs Row */}
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <label
                      ...
                      className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-2 flex items-center gap-1"
                    >
                ...
                <div className="space-y-2">
                  <label
                    htmlFor="creditRateSelect"
                    className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-2"
                  >
                    Puntuación de Crédito <span className="text-red-500">*</span>
                  </label>
