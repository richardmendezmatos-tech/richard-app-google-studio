    ...
    >
      ...
      <div className="p-8 flex-1 flex flex-col">
        <div className="mb-4">
          ...
          <h3 className="text-2xl font-black text-slate-800 dark:text-white tracking-tighter mt-1 group-hover:text-[#00aed9] transition-colors line-clamp-1">
            {car.name}
          </h3>
        </div>
        ...
        <div className="mt-auto flex items-end justify-between border-t border-slate-100 dark:border-slate-700 pt-6">
          <div>
            ...
            <p className="text-[10px] font-bold text-[#00aed9] mt-1">
