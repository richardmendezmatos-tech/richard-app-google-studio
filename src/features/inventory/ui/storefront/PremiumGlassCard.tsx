      ...
      <div className="p-8 flex-1 flex flex-col relative z-20">
        <div className="mb-4">
          <div className="flex items-center gap-2 mb-2">
            <span className="font-tech text-[10px] uppercase tracking-[0.2em] text-[#00aed9]">
              {car.type}
            </span>
          ...
          <h3
            id={`car-title-${car.id}`}
            className="font-cinematic text-[2rem] tracking-[0.04em] text-white transition-colors group-hover:text-[#00aed9] line-clamp-1 drop-shadow-md text-glow"
          >
            {car.name}
          </h3>
        </div>
