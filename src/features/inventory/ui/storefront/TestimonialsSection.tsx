  ...
  const testimonials = [
    {
      ...
      comment:
        'La experiencia con Richard Automotive fue increíble. La IA me ayudó a elegir la SUV perfecta para mi familia y el proceso fue totalmente transparente.',
      rating: 5,
    ...
    },
    {
      ...
      comment:
        "Nunca pensé que comprar un auto eléctrico fuera tan fácil. El 'Neural Match' acertó totalmente con mi estilo de vida. ¡Estoy enamorada de mi IONIQ!",
      rating: 5,
    ...
    },
    {
      ...
      comment:
        'Atención de primera clase. Me trajeron el auto a la oficina para probarlo y cerramos el trato en menos de una hora. Eficiencia pura.',
      rating: 5,
  ...
  return (
    <section className="relative overflow-hidden rounded-[32px] border border-cyan-100/15 bg-[linear-gradient(140deg,rgba(6,16,28,0.95),rgba(2,8,14,0.94))] py-16 sm:rounded-[40px] sm:py-20">
      ...
      <div className="relative z-10 mb-16 space-y-4 text-center">
        <span className="font-tech text-sm uppercase tracking-[0.24em] text-cyan-200">
          Nuestros Clientes
        </span>
      ...
      <div className="relative z-10 grid grid-cols-1 gap-6 px-4 sm:gap-8 md:grid-cols-3">
        {testimonials.map((t) => (
          <div
            key={t.id}
            className="group rounded-[30px] border border-white/10 bg-[#081a2b]/80 p-8 shadow-xl shadow-black/30 transition-all duration-300 hover:-translate-y-2 hover:border-cyan-200/30"
          >
            ...
            <p className="relative z-10 mb-8 leading-relaxed text-slate-300">"{t.comment}"</p>
