            ...
            <div className="sticky top-2 z-30 glass-premium px-4 py-4 md:top-4 md:px-6">
              <div className="mb-4 flex items-center justify-between gap-3 border-b border-white/10 pb-4">
                ...
                <p className="font-tech text-[10px] uppercase tracking-[0.22em] text-slate-300">
                  {displayCars.length} unidades visibles
                </p>
              </div>
              <div className="flex flex-col items-center gap-5 lg:flex-row">
                ...
                <div className="group relative w-full flex-1">
                  <Search
                    className="absolute left-5 top-1/2 -translate-y-1/2 text-slate-400 transition-colors group-focus-within:text-[#31d2ff]"
                    size={22}
                  />
                  <input
                    type="text"
                    placeholder={
                      visualContext
                        ? `Buscando similares a: ${searchTerm}...`
              ...
              {visualContext && (
                <div className="flex items-center gap-3 rounded-r-xl border-l-4 border-[#00aed9] bg-gradient-to-r from-[#00aed9]/15 to-transparent p-3">
                  ...
                  <p className="text-xs text-slate-300">
                    <span className="font-bold text-[#00aed9]">IA:</span> Resultados visuales
                    activos.
                  </p>
                  <button
                    onClick={() => {
                    ...
                    className="ml-2 text-[10px] font-bold underline hover:text-[#00aed9]"
                  >
                    Limpiar
                  </button>
                </div>
                  ...
                  {isSearching ? (
                    <>
                      ...
                      <p className="mt-2 max-w-md text-sm text-slate-400">
                        Prueba cambiar el tipo, limpiar la búsqueda visual o explorar todos los
                        segmentos.
                      </p>
                      <button
                        onClick={() => {
                    ...
                    <>
                      ...
                      {onMagicFix ? (
                        ...
                        <p className="text-slate-500 mb-6 max-w-md">
                          Ve al Admin Panel para configurar.
                        </p>
                      )}
                            ...
                            <div className="text-red-500 mb-2">
                              ...
                              {String(error).includes('requires an index') && (
                                <p className="mt-2 text-xs">
                                  💡 Tip: Falta un índice en Firebase. Revisa la consola o despliega
                                  los índices.
                                </p>
                              )}
                            </div>
