              ...
              <div className="h-full flex flex-col max-w-3xl mx-auto space-y-6 animate-in slide-in-from-bottom-5 duration-300 pb-4">
                <div className="text-center mb-4">
                  <h3 className="text-3xl font-bold text-white mb-2">
                    Háblame de tu estilo de vida.
                  </h3>
                  <p className="text-slate-400 text-sm">
                    Nuestra IA analizará tu perfil psicológico y encontrará el vehículo
                ...
                <div className="w-full mt-4 flex justify-center relative z-20 group pb-8">
                  ...
                  >
                    ...
                    {profile.trim() && (
                      <Sparkles
                        size={32}
                        className="animate-spin-slow text-yellow-300 drop-shadow-md"
                      />
                    )}
                  </button>
                </div>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <div className="text-2xl font-black text-white uppercase tracking-tight">
                        {userPersona || 'Perfil Estándar'}
                      </div>
                    </div>
                  </div>
                  <button
                    onClick={() => setStep('input')}
                    className="px-4 py-2 bg-slate-800 hover:bg-slate-700 text-white rounded-xl text-xs font-bold uppercase tracking-wide transition-colors"
                  >
                    Nuevo Análisis
                  </button>
                </div>
