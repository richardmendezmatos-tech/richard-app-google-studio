...
import { evaluarMargenOperativo } from '@/features/inventory';
import { EstadoUnidad } from '@/features/inventory';
    ...
    <div className="glass-premium p-6 border border-white/10 relative overflow-hidden group h-full flex flex-col">
      ...
      <div className="flex-1 space-y-3 overflow-hidden">
        ...
        {analysis.reports.map((report, idx) => (
          <div
            key={report.id}
            className="flex items-center justify-between p-3 bg-white/2 border border-white/5 rounded-xl hover:bg-white/5 transition-all group/item"
          >
      ...
      {/* Footer */}
      <button className="mt-4 w-full py-3 bg-primary/10 hover:bg-primary text-primary hover:text-white rounded-xl text-[10px] font-black uppercase tracking-widest transition-all flex items-center justify-center gap-2 group/btn">
