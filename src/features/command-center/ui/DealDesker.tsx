...
import { FAndIPackageMenu } from './FAndIPackageMenu';
    ...
    <div className="p-8 max-w-7xl mx-auto space-y-8 animate-in fade-in duration-700">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-2 gap-6 relative">
        ...
        <FAndIPackageMenu
          ...
          loanCalculation={loanCalculation}
          loanPlatinum={loanPlatinum}
          loanGold={loanGold}
          loanSilver={loanSilver}
          loanBase={loanBase}
          applyPlatinum={applyPlatinum}
          applyGold={applyGold}
          applySilver={applySilver}
          applyBase={applyBase}
          extendedWarranty={extendedWarranty}
          gapInsurance={gapInsurance}
          paintProtection={paintProtection}
          powerPack={powerPack}
        />
