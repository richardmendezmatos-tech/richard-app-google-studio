  ...
  return (
    <div className="space-y-8 animate-in fade-in zoom-in-95 duration-700">
      ...
      <div className="flex justify-between items-center px-2">
        <div>
          <h2 className="text-2xl font-black text-white uppercase tracking-tighter">
            B2B Core Performance
          </h2>
          <p className="text-xs text-slate-500 font-bold uppercase tracking-widest">
            Revenue & Inference Analytics
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="glass-premium p-8 rounded-4xl border border-emerald-500/20 bg-linear-to-br from-emerald-500/10 to-transparent relative overflow-hidden group hover:border-emerald-500/40 transition-all duration-500 route-fade-in">
          ...
          <div className="mt-4 flex items-center gap-2">
            <span className="px-2 py-0.5 bg-emerald-500/20 text-emerald-500 text-[9px] font-black rounded-full uppercase">
              Target Reached
            </span>
        ...
        <div className="glass-premium p-8 rounded-4xl border border-amber-500/20 bg-linear-to-br from-amber-500/10 to-transparent relative overflow-hidden group hover:border-amber-500/40 transition-all duration-500 route-fade-in">
          ...
          <div className="mt-4 flex items-center gap-2">
            ...
            <div className="text-[10px] text-slate-500 font-bold uppercase tracking-widest">
              {stats.totalEvents} Llamadas
            </div>
          </div>
        </div>

        <div className="glass-premium p-8 rounded-4xl border border-primary/20 bg-linear-to-br from-primary/10 to-transparent relative overflow-hidden group hover:border-primary/40 transition-all duration-500 route-fade-in">
          ...
          <div className="text-5xl font-black text-white tracking-tighter">
            {((1 - stats.totalCost / (stats.mrr || 1)) * 100).toFixed(1)}%
          </div>
          <div className="mt-4 flex items-center gap-2">
      ...
      <div className="glass-premium rounded-4xl border border-white/10 overflow-hidden bg-slate-900/40 backdrop-blur-3xl">
        <div className="p-8 border-b border-white/5 flex justify-between items-center bg-slate-900/50">
          <div>
            <h3 className="text-lg font-black text-white uppercase tracking-tighter flex items-center gap-2">
              <CreditCard size={20} className="text-primary" /> Historial de Consumo SaaS
            </h3>
            <p className="text-[10px] text-slate-500 font-black uppercase tracking-widest mt-1">
              Transacciones Auditadas por IA
            </p>
          </div>
          <button className="p-3 bg-white/5 hover:bg-primary/20 hover:text-primary rounded-2xl text-slate-400 transition-all border border-transparent hover:border-primary/30 shadow-lg">
            <Download size={18} />
          </button>
        </div>
                ...
                >
                  <td className="px-8 py-5">
                    <div className="flex items-center gap-3">
                      <div className="w-8 h-8 rounded-full bg-slate-800 flex items-center justify-center text-[10px] font-black text-primary border border-white/5">
                  ...
                  <td className="px-8 py-5">
                    <div className="space-y-1">
                      <span className="px-3 py-1 bg-primary/10 rounded-full text-[9px] font-black text-primary uppercase tracking-widest border border-primary/20">
                        {log.eventType}
                      </span>
                  ...
                  <td className="px-8 py-5">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-xs text-slate-300 font-mono">
                        {log.count?.toFixed(0) || 0} <span className="text-slate-600">units</span>
                      </span>
                    </div>
                  </td>
                  ...
                  <td colSpan={4} className="px-6 py-24 text-center">
                    <div className="flex flex-col items-center gap-4 opacity-30">
                      ...
                      <p className="text-xs font-black uppercase tracking-[0.2em] text-slate-500">
                        Auditando Consumo en Tiempo Real...
                      </p>
                    </div>
                  </td>
                </tr>
      ...
      {/* Alert Box */}
      <div className="p-6 bg-amber-500/10 border border-amber-500/20 rounded-4xl flex items-center gap-6 shadow-xl route-fade-in">
        <div className="w-12 h-12 rounded-full bg-amber-500/20 flex items-center justify-center shrink-0">
          <AlertTriangle className="text-amber-500" size={24} />
        </div>
        <div>
          <h4 className="text-[10px] font-bold text-amber-500 uppercase tracking-widest mb-1">
            COO Alert: Umbral de Margen
          </h4>
          <p className="text-xs text-amber-200/60 leading-relaxed font-medium">
            Los costos son estimaciones basadas en Gemini 2.0 Flash. Si un dealer supera los{' '}
            <span className="text-amber-500 font-bold">$5.00 USD/mes</span>, se recomienda escalar
            la cuenta a Tier Enterprise.
          </p>
        </div>
      </div>
    </div>
