        ...
        {activeTab === 'reviews' && (
          <div className="space-y-3">
            {[
              {
                name: 'Carlos Rivera',
                text: 'Excelente servicio, Richard me ayudó en todo el proceso...',
                stars: 5,
              },
              {
                name: 'Marta Ortiz',
                text: 'La Tacoma que compré está impecable. Recomendado.',
                stars: 5,
              },
              {
                name: 'Jose Davila',
                text: 'Esperaba un poco más de rapidez en la entrega, pero el auto está bien.',
                stars: 3,
              },
            ].map((review, i) => (
              <div
