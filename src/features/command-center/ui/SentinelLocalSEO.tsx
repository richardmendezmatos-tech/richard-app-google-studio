...
import { type GBPReview } from './sentinelReviewsTypes';
import { SentinelReviewsTab } from './SentinelReviewsTab';
  ...
  return (
    <div className="bg-slate-900/60 backdrop-blur-xl border border-white/5 rounded-[2.5rem] p-8 space-y-8 relative overflow-hidden group">
      ...
      <div className="space-y-4 relative z-10">
        ...
        {activeTab === 'reviews' && (
          <SentinelReviewsTab reviews={reviews} gbpConnected={gbpConnected} />
        )}
      </div>
    </div>
  );
