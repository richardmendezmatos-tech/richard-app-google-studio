...
const EarlyAdopterOnboard = () => {
  ...
  const handleOnboardPrestige = async () => {
    ...
    const prestigeConfig = {
      ...
      welcomeMessage:
        'Bienvenido a Prestige Auto Group. La mejor selección BMW & Mercedes de la región.',
    };
    ...
    <div className="min-h-screen bg-[#020617] text-white flex items-center justify-center p-6">
      <div className="max-w-md w-full bg-slate-900 border border-slate-700 rounded-4xl p-10 shadow-2xl">
        <div className="flex items-center gap-3 text-emerald-400 mb-8">
          <Handshake size={40} />
          <h1 className="text-3xl font-black uppercase tracking-tighter">Configuración Inicial</h1>
        </div>

        <p className="text-slate-400 mb-10 text-sm leading-relaxed font-medium">
          Ejecutando la acción <strong>#701</strong> de nuestro Balanced Scorecard. Alta real del
          primer concesionario Early Adopter: <strong>Prestige Auto Group</strong>.
        </p>
