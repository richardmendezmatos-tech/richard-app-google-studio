        ...
        <div className="flex-1 overflow-hidden flex flex-col lg:flex-row">
          ...
          <div className="w-full lg:w-1/2 p-8 overflow-y-auto custom-scrollbar bg-white dark:bg-slate-900">
            ...
            <form ref={formRef} onSubmit={handleSubmit} className="space-y-8">
              ...
              {/* Basic Info */}
              <VehicleBasicInfoFields car={car} />
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center mb-1">
                  ...
                  <button
                    ...
                    className="text-[10px] font-black uppercase tracking-widest text-primary bg-primary/10 px-3 py-1.5 rounded-full flex items-center gap-2 hover:bg-primary hover:text-white transition-all disabled:opacity-50"
                  >
                    {isGenerating ? (
