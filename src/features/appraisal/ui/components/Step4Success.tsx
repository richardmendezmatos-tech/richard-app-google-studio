...
export const Step4Success: React.FC<Step4SuccessProps> = ({ result, onReset }) => {
  return (
    ...
    >
      ...
      <h3 className="text-[10px] font-black text-emerald-400 uppercase tracking-[0.3em] mb-2">
        Oferta Estimada Richard Certified
      </h3>
      ...
      <p className="text-xs text-slate-400 mb-10 max-w-sm mx-auto uppercase tracking-wide leading-relaxed">
        Basado en el historial de mercado de hoy. Esta oferta es tentativa y se honrará tras la
        inspección física en Richard Automotive.
      </p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <button className="py-5 bg-[#25D366] text-white rounded-2xl font-black uppercase tracking-widest text-[10px] shadow-lg shadow-[#25D366]/20 flex items-center justify-center gap-2 hover:scale-105 transition-all font-tech">
