...
import { generateCarMarketingContent, MarketingContent } from '../../services/marketingService';
                ...
                <div className="flex-1 overflow-y-auto p-8 space-y-8 custom-scrollbar">
                    {loading ? (
                        <div className="flex flex-col items-center justify-center py-20 space-y-4">
                            ...
                            <p className="text-sm font-black uppercase tracking-widest text-[#00aed9] animate-pulse">Generando Estrategia...</p>
                        </div>
                    ) : content && (
