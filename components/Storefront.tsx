                        ...
                        <div className="flex gap-4 items-center w-full lg:w-auto overflow-x-auto pb-2 lg:pb-0">
                            ...
                            <div className="flex items-center gap-2 p-1.5 bg-white dark:bg-slate-800 rounded-full border border-slate-100 dark:border-slate-700">
                                <button
                                    ...
                                    className={`px-4 py-3 rounded-full flex items-center gap-2 text-xs font-bold uppercase tracking-wide transition-all ${sortOrder === 'asc' ? 'bg-[#00aed9] text-white' : 'text-slate-500 hover:bg-slate-100 dark:hover:bg-slate-700'
                                        }`}
                                    title="Menor Precio"
                                >
                                ...
                                <button
                                    ...
                                    className={`px-4 py-3 rounded-full flex items-center gap-2 text-xs font-bold uppercase tracking-wide transition-all ${sortOrder === 'desc' ? 'bg-[#00aed9] text-white' : 'text-slate-500 hover:bg-slate-100 dark:hover:bg-slate-700'
                                        }`}
                                    title="Mayor Precio"
                                >
    ...
    return (
        <section className="py-20 relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 px-4">
                {testimonials.map((t) => (
                    <div key={t.id} className="bg-slate-50 dark:bg-slate-800/50 p-8 rounded-[30px] border border-slate-100 dark:border-slate-700 relative hover:transform hover:-translate-y-2 transition-transform duration-300">
                        <div className="absolute top-8 right-8 text-[#00aed9]/20">
                        ...
                        <div className="flex items-center gap-4 border-t border-slate-200 dark:border-slate-700 pt-6">
                            <img src={t.img} alt={t.name} className="w-12 h-12 rounded-full object-cover ring-2 ring-[#00aed9]/30" />
                            <div>
